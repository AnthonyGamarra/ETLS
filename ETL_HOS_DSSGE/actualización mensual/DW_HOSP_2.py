...
for start_mes, end_mes in month_range(start_date, end_date):
    ...
    tabla_destino = f"dssge.dw_hosp_v2_{anio}_{mes}"
    ...
    SELECT
            ...
            (FLOOR(MONTHS_BETWEEN(t.hospinthor, d.pernacfec) / 12))            as ANIO_EDAD,
            (FLOOR(MOD(MONTHS_BETWEEN(t.hospinthor, d.pernacfec), 12)))        as MESES,       
