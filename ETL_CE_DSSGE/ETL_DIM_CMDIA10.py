...
# ==============================
query = "SELECT * FROM SGSS.cmdia10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmdia10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmdia10", engine_pg, schema="dssge", if_exists="replace", index=False)
