...
# ==============================
query = "SELECT * FROM SGSS.cmact10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmact10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmact10", engine_pg, schema="dssge", if_exists="replace", index=False)
