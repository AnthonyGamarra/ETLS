...
# ==============================
query = "SELECT * FROM SGSS.cmras10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmras10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmras10", engine_pg, schema="dssge", if_exists="replace", index=False)
