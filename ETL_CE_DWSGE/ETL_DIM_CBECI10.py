...
# ==============================
query = "SELECT * FROM SGSS.cbeci10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbeci10 RESTART IDENTITY;"))
...
df = df.astype(str) 
df.to_sql("sgss_cbeci10", engine_pg, schema="dwsge", if_exists="append", index=False)
