...
# ==============================
query = "SELECT * FROM SGSS.QBCEP10"
...
#     conn.execute(text("TRUNCATE TABLE dwsge.sgss_qbcep10 RESTART IDENTITY;"))
...
df.to_sql("sgss_qbcep10", engine_pg, schema="dwsge", if_exists="replace", index=False)
