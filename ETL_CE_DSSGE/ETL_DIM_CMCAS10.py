...
# ==============================
query = "SELECT * FROM SGSS.cmcas10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmcas10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmcas10", engine_pg, schema="dssge", if_exists="replace", index=False)
