...
# ==============================
query = "SELECT * FROM SGSS.cbepc10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cbepc10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbepc10", engine_pg, schema="dssge", if_exists="replace", index=False)
