...
# ==============================
query = "SELECT * FROM SGSS.cbcot10"
...
#     conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbcot10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbcot10", engine_pg, schema="dwsge", if_exists="append", index=False)
