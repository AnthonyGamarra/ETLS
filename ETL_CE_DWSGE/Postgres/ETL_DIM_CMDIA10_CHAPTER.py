...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cmdia10_chapter RESTART IDENTITY;"))
...
df.to_sql("sgss_cmdia10_chapter", engine_pg, schema="dwsge", if_exists="append", index=False)
