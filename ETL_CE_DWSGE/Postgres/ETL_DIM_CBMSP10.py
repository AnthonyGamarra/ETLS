...
# ==============================
query = "SELECT * FROM SGSS.cbmsp10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbmsp10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbmsp10", engine_pg, schema="dwsge", if_exists="replace", index=False)
