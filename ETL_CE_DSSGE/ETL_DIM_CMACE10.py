...
# ==============================
query = "SELECT * FROM SGSS.cmace10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmace10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmace10", engine_pg, schema="dssge", if_exists="replace", index=False)
