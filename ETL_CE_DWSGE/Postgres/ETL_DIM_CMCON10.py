...
# ==============================
query = "SELECT * FROM SGSS.cmcon10"
...
##    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cmcon10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmcon10", engine_pg, schema="dwsge", if_exists="replace", index=False)
