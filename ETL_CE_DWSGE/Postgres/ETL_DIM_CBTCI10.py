...
# ==============================
query = "SELECT * FROM SGSS.cbtci10"
...
##    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbtci10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbtci10", engine_pg, schema="dwsge", if_exists="replace", index=False)
