...
# ==============================
query = "SELECT * FROM SGSS.QBGCC10"
...
#     conn.execute(text("TRUNCATE TABLE dwsge.sgss_qbgcc10 RESTART IDENTITY;"))
...
df.to_sql("sgss_qbgcc10", engine_pg, schema="dwsge", if_exists="replace", index=False)
