...
# ==============================
query = "SELECT * FROM SGSS.QBESO10"
...
#     conn.execute(text("TRUNCATE TABLE dwsge.sgss_qbeso10 RESTART IDENTITY;"))
...
df.to_sql("sgss_qbeso10", engine_pg, schema="dwsge", if_exists="replace", index=False)
