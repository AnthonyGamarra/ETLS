...
# ==============================
query = "SELECT * FROM SGSS.cbtpc10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cbtpc10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbtpc10", engine_pg, schema="dssge", if_exists="replace", index=False)
