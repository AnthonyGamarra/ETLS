...
# ==============================
query = "SELECT * FROM SGSS.cbtdi10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cbtdi10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbtdi10", engine_pg, schema="dssge", if_exists="replace", index=False)
