...
# ==============================
query = "SELECT * FROM SGSS.cmtco10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmtco10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmtco10", engine_pg, schema="dssge", if_exists="replace", index=False)
