...
# ==============================
query = "SELECT * FROM SGSS.cbcoc10"
...
#with engine_pg.begin() as conn:
 ...
 #   conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbcoc10 RESTART IDENTITY;"))
...
df = df.astype(str) 
df.to_sql("sgss_cbcoc10", engine_pg, schema="dwsge", if_exists="append", index=False)
