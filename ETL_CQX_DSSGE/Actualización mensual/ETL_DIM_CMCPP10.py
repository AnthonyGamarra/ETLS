...
# ==============================
query = "SELECT * FROM SGSS.CMCPP10"
...
#     conn.execute(text("TRUNCATE TABLE dwsge.sgss_qppso10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmcpp10", engine_pg, schema="dwsge", if_exists="replace", index=False)
