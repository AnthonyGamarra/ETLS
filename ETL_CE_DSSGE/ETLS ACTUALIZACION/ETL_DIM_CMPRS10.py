...
# ==============================
query = "SELECT * FROM SGSS.cmprs10"
...
#     conn.execute(text("TRUNCATE TABLE dssge.sgss_cmprs10 RESTART IDENTITY;"))

# ==============================
# 5. Cargar datos a PostgreSQL
# ==============================
df.columns = df.columns.str.lower() 
df.to_sql("sgss_cmprs10", engine_pg, schema="dssge", if_exists="replace", index=False)
