...
# ==============================
query = "SELECT * FROM SGSS.cbtpa10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dwsge.sgss_cbtpa10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cbtpa10", engine_pg, schema="dwsge", if_exists="replace", index=False)
