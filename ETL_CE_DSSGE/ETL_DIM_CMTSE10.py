...
# ==============================
query = "SELECT * FROM SGSS.cmtse10"
...
with engine_pg.begin() as conn:
    ...
    conn.execute(text("TRUNCATE TABLE dssge.sgss_cmtse10 RESTART IDENTITY;"))
...
df.to_sql("sgss_cmtse10", engine_pg, schema="dssge", if_exists="replace", index=False)
